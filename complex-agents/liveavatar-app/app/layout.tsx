            ...
            <div className="text-foreground flex items-center gap-3 text-right font-mono text-[11px] font-bold tracking-wider uppercase md:text-xs">
              <span>
                ...
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://docs.vonative.com"
                  className="underline underline-offset-4"
                >
                  <span className="sm:hidden">Vonative docs</span>
                  <span className="hidden sm:inline">Vonative Agents</span>
                </a>
              </span>
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://github.com/boboyii-app"
                aria-label="Vonative GitHub repository"
